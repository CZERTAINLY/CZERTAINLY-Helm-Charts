...
```bash
helm show values oci://harbor.3key.company/czertainly-helm/adcs-net-connector > values.yaml
```
...
```bash
helm install --namespace czertainly -f values.yaml czertainly-adcs-net-connector oci://harbor.3key.company/czertainly-helm/adcs-net-connector
```
...
```bash
helm upgrade --namespace czertainly -f values.yaml czertainly-adcs-net-connector oci://harbor.3key.company/czertainly-helm/adcs-net-connector
```
...
```bash
helm uninstall --namespace czertainly czertainly-adcs-net-connector
```
...
| image.name                                   | `czertainly-adcs-net-connector` | Docker image name                                                     |

...
*/}}
{{- define "email-notification-provider.name" -}}
...
*/}}
{{- define "email-notification-provider.fullname" -}}
...
*/}}
{{- define "email-notification-provider.chart" -}}
...
Common labels
*/}}
{{- define "email-notification-provider.labels" -}}
helm.sh/chart: {{ include "email-notification-provider.chart" . }}
{{ include "email-notification-provider.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "email-notification-provider.selectorLabels" -}}
app.kubernetes.io/name: {{ include "email-notification-provider.name" . }}
...
*/}}
{{- define "email-notification-provider.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "email-notification-provider.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "email-notification-provider.image" -}}
...
*/}}
{{- define "email-notification-provider.curl.image" -}}
...
*/}}
{{- define "email-notification-provider.imagePullSecrets" -}}
...
*/}}
{{- define "email-notification-provider.ephemeralVolume" -}}
...
*/}}
{{- define "email-notification-provider.customization.initContainers" -}}
...
*/}}
{{- define "email-notification-provider.customization.sidecarContainers" -}}
...
*/}}
{{- define "email-notification-provider.customization.volumes" -}}
...
*/}}
{{- define "email-notification-provider.customization.volumeMounts" -}}
...
*/}}
{{- define "email-notification-provider.customization.ports" -}}
...
*/}}
{{- define "email-notification-provider.customization.env" -}}
...
*/}}
{{- define "email-notification-provider.customization.envFrom" -}}
...
*/}}
{{- define "email-notification-provider.image.command" -}}
{{- include "czertainly-lib.tplvalues.render" (dict "value" .Values.image.command "context" $) }}
{{- end -}}

{{- define "email-notification-provider.image.args" -}}

...
```bash
helm show values oci://hub.omnitrustregistry.com/ilm-helm/network-discovery-provider > values.yaml
```
...
```bash
helm install --namespace ilm -f values.yaml ilm-network-discovery-provider oci://hub.omnitrustregistry.com/ilm-helm/network-discovery-provider
```
...
```bash
helm upgrade --namespace ilm -f values.yaml ilm-network-discovery-provider oci://hub.omnitrustregistry.com/ilm-helm/network-discovery-provider
```
...
```bash
helm uninstall --namespace ilm ilm-network-discovery-provider
```
...
| serviceAccount.name                          | `"network-discovery-provider-sa"`  | The name of the service account to use. If not set and create is true, a name is generated using the fullname template |

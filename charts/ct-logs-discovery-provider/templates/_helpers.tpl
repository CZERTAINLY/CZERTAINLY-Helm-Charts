...
*/}}
{{- define "ct-logs-discovery-provider.name" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.fullname" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.chart" -}}
...
Common labels
*/}}
{{- define "ct-logs-discovery-provider.labels" -}}
helm.sh/chart: {{ include "ct-logs-discovery-provider.chart" . }}
{{ include "ct-logs-discovery-provider.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "ct-logs-discovery-provider.selectorLabels" -}}
app.kubernetes.io/name: {{ include "ct-logs-discovery-provider.name" . }}
...
*/}}
{{- define "ct-logs-discovery-provider.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ct-logs-discovery-provider.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "ct-logs-discovery-provider.image" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.curl.image" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.imagePullSecrets" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.customization.initContainers" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.customization.sidecarContainers" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.customization.volumes" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.customization.volumeMounts" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.customization.ports" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.customization.env" -}}
...
*/}}
{{- define "ct-logs-discovery-provider.customization.envFrom" -}}

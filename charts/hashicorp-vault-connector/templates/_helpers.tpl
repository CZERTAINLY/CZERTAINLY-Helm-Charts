...
*/}}
{{- define "hashicorp-vault-connector.name" -}}
...
*/}}
{{- define "hashicorp-vault-connector.fullname" -}}
...
*/}}
{{- define "hashicorp-vault-connector.chart" -}}
...
Common labels
*/}}
{{- define "hashicorp-vault-connector.labels" -}}
helm.sh/chart: {{ include "hashicorp-vault-connector.chart" . }}
{{ include "hashicorp-vault-connector.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "hashicorp-vault-connector.selectorLabels" -}}
app.kubernetes.io/name: {{ include "hashicorp-vault-connector.name" . }}
...
*/}}
{{- define "hashicorp-vault-connector.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "hashicorp-vault-connector.fullname" .) .Values.serviceAccount.name }}
{{- else }}

...
*/}}
{{- define "network-discovery-provider.image" -}}
...
*/}}
{{- define "network-discovery-provider.curl.image" -}}
...
*/}}
{{- define "network-discovery-provider.imagePullSecrets" -}}
...
*/}}
{{- define "network-discovery-provider.ephemeralVolume" -}}
...
*/}}
{{- define "network-discovery-provider.customization.initContainers" -}}
...
*/}}
{{- define "network-discovery-provider.customization.sidecarContainers" -}}
...
*/}}
{{- define "network-discovery-provider.customization.volumes" -}}
...
*/}}
{{- define "network-discovery-provider.customization.volumeMounts" -}}
...
*/}}
{{- define "network-discovery-provider.customization.ports" -}}
...
*/}}
{{- define "network-discovery-provider.customization.env" -}}
...
*/}}
{{- define "network-discovery-provider.customization.envFrom" -}}
...
*/}}
{{- define "network-discovery-provider.image.command" -}}
{{- include "czertainly-lib.tplvalues.render" (dict "value" .Values.image.command "context" $) }}
{{- end -}}

{{- define "network-discovery-provider.image.args" -}}

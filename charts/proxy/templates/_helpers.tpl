...
{{/*
Return the image name - uses library helper to merge global/local values
*/}}
{{- define "proxy.image" -}}
...
{{/*
Return the image pull secret names - uses library helper
*/}}
...
{{/*
Return ephemeral volume configuration - uses library helper
*/}}
{{- define "proxy.ephemeralVolume" -}}
...
*/}}
{{- define "proxy.customization.initContainers" -}}
...
*/}}
{{- define "proxy.customization.sidecarContainers" -}}
...
*/}}
{{- define "proxy.customization.volumes" -}}
...
*/}}
{{- define "proxy.customization.volumeMounts" -}}
...
*/}}
{{- define "proxy.customization.ports" -}}
...
*/}}
{{- define "proxy.customization.env" -}}
...
{{/*
Render customized environment variables from configmaps and secrets
*/}}
{{- define "proxy.customization.envFrom" -}}
...
{{/*
Render customized command, if any
*/}}
{{- define "proxy.image.command" -}}
{{- include "czertainly-lib.tplvalues.render" (dict "value" .Values.image.command "context" $) }}
{{- end -}}

{{/*
Render customized args, if any
*/}}
{{- define "proxy.image.args" -}}

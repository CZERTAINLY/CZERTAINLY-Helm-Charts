...
```bash
helm show values oci://hub.omnitrustregistry.com/ilm-helm/pg-bouncer > values.yaml
```
...
```bash
helm install --namespace ilm -f values.yaml ilm-pg-bouncer oci://hub.omnitrustregistry.com/ilm-helm/pg-bouncer
```
...
```bash
helm upgrade --namespace ilm -f values.yaml ilm-pg-bouncer oci://hub.omnitrustregistry.com/ilm-helm/pg-bouncer
```
...
```bash
helm uninstall --namespace ilm ilm-pg-bouncer
```
...
| Parameter                                      | Default value            | Description                                                                                                            |
|------------------------------------------------|--------------------------|------------------------------------------------------------------------------------------------------------------------|
| nameOverride                                   | `pg-bouncer`                             | Override for the chart name. Used as the `app.kubernetes.io/name` selector label value and as input to the fullname helper. Pinned to keep selectors stable across chart renames; changing this requires manual cleanup of existing Deployments. |

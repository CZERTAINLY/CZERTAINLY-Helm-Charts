...
```bash
helm show values czertainly/common-credential-provider > values.yaml
```
...
```bash
helm install --namespace czertainly -f values.yaml czertainly-common-credential-provider czertainly/common-credential-provider
```
...
```bash
helm upgrade --namespace czertainly -f values.yaml czertainly-common-credential-provider czertainly/common-credential-provider
```

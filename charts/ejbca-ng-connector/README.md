...
```bash
helm show values oci://hub.omnitrustregistry.com/ilm-helm/ejbca-ng-connector > values.yaml
```
...
```bash
helm install --namespace ilm -f values.yaml ilm-ejbca-ng-connector oci://hub.omnitrustregistry.com/ilm-helm/ejbca-ng-connector
```
...
```bash
helm upgrade --namespace ilm -f values.yaml ilm-ejbca-ng-connector oci://hub.omnitrustregistry.com/ilm-helm/ejbca-ng-connector
```
...
```bash
helm uninstall --namespace ilm ilm-ejbca-ng-connector
```
...
| Parameter                                    | Default value                   | Description                                                                                                            |
|----------------------------------------------|---------------------------------|------------------------------------------------------------------------------------------------------------------------|
| nameOverride                                 | `ejbca-ng-connector`                            | Override for the chart name. Used as the `app.kubernetes.io/name` selector label value and as input to the fullname helper. Pinned to keep selectors stable across chart renames; changing this requires manual cleanup of existing Deployments. |
...
| image.name                                   | `ejbca-ng-connector` | Docker image name                                                                                                      |

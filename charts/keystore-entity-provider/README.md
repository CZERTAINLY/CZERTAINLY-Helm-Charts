...
```bash
helm show values oci://hub.omnitrustregistry.com/ilm-helm/keystore-entity-provider > values.yaml
```
...
```bash
helm install --namespace ilm -f values.yaml ilm-keystore-entity-provider oci://hub.omnitrustregistry.com/ilm-helm/keystore-entity-provider
```
...
```bash
helm upgrade --namespace ilm -f values.yaml ilm-keystore-entity-provider oci://hub.omnitrustregistry.com/ilm-helm/keystore-entity-provider
```
...
```bash
helm uninstall --namespace ilm ilm-keystore-entity-provider
```
...
| Parameter                                    | Default value                         | Description                                                                                                            |
|----------------------------------------------|---------------------------------------|------------------------------------------------------------------------------------------------------------------------|
| nameOverride                                 | `keystore-entity-provider`                            | Override for the chart name. Used as the `app.kubernetes.io/name` selector label value and as input to the fullname helper. Pinned to keep selectors stable across chart renames; changing this requires manual cleanup of existing Deployments. |
...
| image.name                                   | `keystore-entity-provider` | Docker image name                                                                                                      |
| image.tag                                    | `1.4.2`                               | Docker image tag                                                                                                       |

...
| global.admin.username                     | `"czertainly-admin"`         | Initial administrator username                                        |
| global.admin.password                     | `"your-strong-password"`     | Initial administrator password                                        |
| global.admin.name                         | `"admin"`                    | Initial administrator first name                                      |
| global.admin.surname                      | `"admin"`                    | Initial administrator last name                                       |
| global.admin.email                        | `"admin@czertainly.local"`   | Initial administrator email                                           |
...
| registerAdmin.admin.username                 | `""`                                                                                                                                                                                                                                                                                                                                         | Username of the administrator                                                                                                                                                                                                            |
| registerAdmin.admin.name                     | `""`                                                                                                                                                                                                                                                                                                                                         | Name of the administrator                                                                                                                                                                                                                |
| registerAdmin.admin.surname                  | `""`                                                                                                                                                                                                                                                                                                                                         | Surname of the administrator                                                                                                                                                                                                             |
| registerAdmin.admin.email                    | `""`                                                                                                                                                                                                                                                                                                                                         | Email of the administrator                                                                                                                                                                                                               |

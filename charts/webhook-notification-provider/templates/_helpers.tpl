...
*/}}
{{- define "webhook-notification-provider.name" -}}
...
*/}}
{{- define "webhook-notification-provider.fullname" -}}
...
*/}}
{{- define "webhook-notification-provider.chart" -}}
...
Common labels
*/}}
{{- define "webhook-notification-provider.labels" -}}
helm.sh/chart: {{ include "webhook-notification-provider.chart" . }}
{{ include "webhook-notification-provider.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "webhook-notification-provider.selectorLabels" -}}
app.kubernetes.io/name: {{ include "webhook-notification-provider.name" . }}
...
*/}}
{{- define "webhook-notification-provider.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "webhook-notification-provider.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "webhook-notification-provider.image" -}}
...
*/}}
{{- define "webhook-notification-provider.curl.image" -}}
...
*/}}
{{- define "webhook-notification-provider.imagePullSecrets" -}}
...
*/}}
{{- define "webhook-notification-provider.customization.initContainers" -}}
...
*/}}
{{- define "webhook-notification-provider.customization.sidecarContainers" -}}
...
*/}}
{{- define "webhook-notification-provider.customization.volumes" -}}
...
*/}}
{{- define "webhook-notification-provider.customization.volumeMounts" -}}
...
*/}}
{{- define "webhook-notification-provider.customization.ports" -}}
...
*/}}
{{- define "webhook-notification-provider.customization.env" -}}
...
*/}}
{{- define "webhook-notification-provider.customization.envFrom" -}}
...
*/}}
{{- define "webhook-notification-provider.image.command" -}}
{{- include "czertainly-lib.tplvalues.render" (dict "value" .Values.image.command "context" $) }}
{{- end -}}

{{- define "webhook-notification-provider.image.args" -}}

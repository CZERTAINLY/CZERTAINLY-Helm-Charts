...
*/}}
{{- define "fe-administrator.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "fe-administrator.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "fe-administrator.curl.image" -}}
